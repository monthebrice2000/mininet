...
def topology():
    ...
    ap1 = net.addAPSensor('ap1', wlans=4, ssid='ssid1, , ,', mode='g', ip='10.0.0.10/8', position='74,204,0' ,range=100 ,voltage=3.7, panid='0xbeef', cls=RSU)
    ap2 = net.addAPSensor('ap2', wlans=4, ssid='ssid2, , ,', mode='g', ip='20.0.0.20/8', position='84,300,0' ,range=100 , voltage=3.7, panid='0xbeef',cls=RSU)
    ap3 = net.addAPSensor('ap3', wlans=4, ssid=', , ,', mode='g', ip='30.0.0.30/8', position='164,274,0' ,range=100 , voltage=3.7, panid='0xbeef',cls=RSU)
    ap4 = net.addAPSensor('ap4', wlans=4, ssid='ssid4, , ,', mode='g', ip='40.0.0.40/8', position='244,300,0' ,range=100 , voltage=3.7, panid='0xbeef',cls=RSU)
    ap5 = net.addAPSensor('ap5', wlans=4, ssid=', , ,', mode='g', ip='50.0.0.50/8', position='224,174,0' ,range=100 , voltage=3.7, panid='0xbeef',cls=RSU)
    ap6 = net.addAPSensor('ap6', wlans=4, ssid='ssid6, , ,', mode='g', ip='60.0.0.60/8', position='304,154,0' ,range=100 , voltage=3.7, panid='0xbeef',cls=RSU)
    ap7 = net.addAPSensor('ap7', wlans=4, ssid='ssid7, , ,', mode='g', ip='70.0.0.70/8', position='340,274,0' ,range=100 , voltage=3.7, panid='0xbeef',cls=RSU)
    ap8 = net.addAPSensor('ap8', wlans=4, ssid='ssid8, , ,', mode='g', ip='80.0.0.80/8', position='420,144,0' ,range=100 , voltage=3.7, panid='0xbeef',cls=RSU)
    ap9 = net.addAPSensor('ap9', wlans=4, ssid='ssid9, , ,', mode='g', ip='90.0.0.90/8', position='420,264,0' ,range=100 , voltage=3.7, panid='0xbeef',cls=RSU)
    ap10 = net.addAPSensor('ap10', wlans=4, ssid='ssid2, , ,', mode='g', ip='100.0.0.100/8', position='144,114,0' ,range=100 , voltage=3.7, panid='0xbeef',cls=RSU)
