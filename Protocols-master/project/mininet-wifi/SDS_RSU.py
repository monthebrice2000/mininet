...
#        OVSKernelAP.__init__(self, name, **pars)
        ...
        self.capacity = self.NO_of_RACKS* self.NO_of_Dir*self.NO_of_files*self.file_size
    ...
    def Handle_controller_packets(self,status,message):
  	...
  	def get_capacity(self):
  		return self.NO_of_RACKS* self.NO_of_Dir*self.NO_of_files*self.file_size
