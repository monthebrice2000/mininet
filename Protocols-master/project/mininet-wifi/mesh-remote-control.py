...
def topology():
    ...
    ap3 = net.addAccessPoint('ap3', wlans=4, ssid=', , ,', mode='g', ip='30.0.0.30/8', position='164,274,0')
    ap4 = net.addAccessPoint('ap4', wlans=4, ssid='ssid4, , ,', mode='g', ip='40.0.0.40/8', position='244,300,0')
    ap5 = net.addAccessPoint('ap5', wlans=4, ssid=', , ,', mode='g', ip='50.0.0.50/8', position='224,174,0')
    ...
    print("sta1 : {}\n sta2 : {}\n sta3 : {} \n".format(sta1.wintfs[0].consumption, sta2.wintfs[0].consumption, sta3.wintfs[0].consumption))"""
