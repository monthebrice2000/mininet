...
def topology():
    ...
    ap1 = net.addAccessPoint('ap1', wlans=4, ip="10.0.0.1/8", ssid='ssid1', mode='g', position='74,204,0')
    ap2 = net.addAccessPoint('ap2', wlans=4, ip="20.0.0.1/8", ssid='ssid2', mode='g', position='84,300,0')
    ap3 = net.addAccessPoint('ap3', wlans=4, ip="30.0.0.1/8", ssid='ssid3', mode='g', position='164,274,0')
    ap4 = net.addAccessPoint('ap4', wlans=4, ip="40.0.0.1/8", ssid='ssid4', mode='g', position='244,300,0')
    ap5 = net.addAccessPoint('ap5', wlans=4, ip="50.0.0.1/8", ssid='ssid5', mode='g', position='224,174,0')
    ap6 = net.addAccessPoint('ap6', wlans=4, ip="60.0.0.1/8", ssid='ssid6', mode='g', position='304,154,0')
    ap7 = net.addAccessPoint('ap7', wlans=4, ip="70.0.0.1/8", ssid='ssid7', mode='g', position='340,274,0')
    ap8 = net.addAccessPoint('ap8', wlans=4, ip="80.0.0.1/8", ssid='ssid8', mode='g', position='420,144,0')
    ap9 = net.addAccessPoint('ap9', wlans=4, ip="90.0.0.1/8", ssid='ssid9', mode='g', position='420,264,0')
    ap10 = net.addAccessPoint('ap10', wlans=4, ip="100.0.0.1/8", ssid='ssid10', mode='g', position='144,114,0')
